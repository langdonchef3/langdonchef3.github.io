...
jQuery(function($){"use strict";var config=$('html').data('config')||{},preloader=$('.tm-preload');$('article[data-permalink]').socialButtons(config);$(".uk-offcanvas-bar .uk-parent").removeClass("uk-open").children("a").attr("href","#");$(document).ready(function(){var browser_width1=$(window).width();$(".tm-navbar").find("li.uk-parent > ul").each(function(index){var offset1=$(this).offset();var xwidth1=offset1.left+$(this).width();if(xwidth1>=browser_width1){$(this).addClass("uk-dropdown-flip");}});})
$(window).resize(function(){var browser_width=$(window).width();$(".tm-navbar").find("li.uk-parent > ul").removeClass("uk-dropdown-flip");$(".tm-navbar").find("li.uk-parent > ul").each(function(index){var offset=$(this).offset();var xwidth=offset.left+$(this).width();if(xwidth>=browser_width){$(this).addClass("uk-dropdown-flip");}});});$(window).on("load",function(){preloader.removeClass('loading').fadeOut(500,function(){})}),$(window).on("beforeunload",function(){preloader.addClass('loading').fadeIn(300,function(){})});});